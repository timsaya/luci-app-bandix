...
const translations = {
    'zh-cn': {
        ...
        '速度值不能为负数': '速度值不能为负数',
        '请输入完整的小数': '请输入完整的小数',
        '请设置开始时间和结束时间': '请设置开始时间和结束时间',
        '结束时间必须晚于开始时间': '结束时间必须晚于开始时间',
        '未设置限速值和时间范围，已自动恢复为永久生效': '未设置限速值和时间范围，已自动恢复为永久生效',
        '未设置有效的限速值，已自动恢复为永久生效': '未设置有效的限速值，已自动恢复为永久生效',
        '未设置完整的时间范围，已自动恢复为永久生效': '未设置完整的时间范围，已自动恢复为永久生效',
        '未选择生效日期，已自动恢复为永久生效': '未选择生效日期，已自动恢复为永久生效',
        '有未保存的更改，确定要取消吗？': '有未保存的更改，确定要取消吗？',
        '请选择生效日期': '请选择生效日期',
        '✓ 限速生效中': '✓ 限速生效中',
        '当前时间不在限速时段内': '当前时间不在限速时段内',
        '请输入有效的速度值': '请输入有效的速度值',
        '请设置完整的时间范围': '请设置完整的时间范围',
        '时间格式错误': '时间格式错误',
        '周一': '周一',
        '周二': '周二',
        '周三': '周三',
